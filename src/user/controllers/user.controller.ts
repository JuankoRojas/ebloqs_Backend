...
export class UserController {
    ...
    @Post('/documents')
    createDocument(@Req() req: Request, @UploadedFile('file') file: Express.Multer.File, @Body() type: string) {
        return this.docService.createDocument(file, req['user']['userId'], type['type']);
    }
